...
function OverlayItem(props) {
  ...
  return (
    ...
    >
      ...
      <span
        className={`ml-0 mr-2 shrink-0 font-medium ${id === 'CaseTitle' || id === 'OverlayField:case_id' ? 'text-white/60' : 'text-white/80'}`}
      >
        {value}
      </span>
    </div>
...
function ZoomOverlayItem({ scale, customization }: OverlayItemProps) {
  return (
    ...
    >
      <span className="mr-0.5 shrink-0 opacity-[0.80]">Zoom:</span>
    ...
    >
      <span>
        {instanceNumber !== undefined && instanceNumber !== null ? (
          <>
            <span className="mr-0.5 shrink-0 opacity-[0.80]">I:</span>
