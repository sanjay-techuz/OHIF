...
const defineValues = {
  ...
  'process.env.REACT_APP_CRYPTO_SECURE_KEY': JSON.stringify(
    process.env.REACT_APP_CRYPTO_SECURE_KEY || ''
  ),
  'process.env.REACT_APP_API_BASE_URL': JSON.stringify(process.env.REACT_APP_API_BASE_URL || ''),
  'process.env.REACT_APP_LMS_LOGIN_URL': JSON.stringify(process.env.REACT_APP_LMS_LOGIN_URL || ''),
